  ...
  const filteredLinks = useMemo(() => {
    return links.filter(link => {
      ...
      if (searchQuery) {
        ...
        const matchesDestination = link.destination.toLowerCase().includes(query);
      ...
      if (statusFilter !== "all") {
        ...
        if (statusFilter === "active" && link.expiresAt && new Date(link.expiresAt) <= new Date()) return false;
      }
      ...
      if (selectedTags.length > 0) {
        ...
        if (!selectedTags.every(tag => linkTagNames.includes(tag))) return false;
      }
        ...
        <div className="card bg-base-100 shadow-lg">
          <div className="card-body">
            <div className="flex flex-wrap gap-4 items-center">
              ...
              {(searchQuery || statusFilter !== "all" || passwordFilter !== "all" || selectedTags.length > 0) && (
                <button
                  onClick={() => {
                    setSearchQuery("");
                    setStatusFilter("all");
                ...
                <thead>
                  <tr>
                    <th className="w-12">
                      ...
                      >
                        {selectedLinks.length === paginatedLinks.length && paginatedLinks.length > 0 ? (
                      ...
                      <td>
                        <div className="flex items-center gap-2">
                          {isExpired(link.expiresAt) ? (
                            ...
                            <div className="badge badge-warning badge-sm">Expires Soon</div>
                          ) : (
                      ...
                      <td>
                        <div className="dropdown dropdown-left">
                          ...
                          <ul tabIndex={0} className="dropdown-content z-10 menu p-2 shadow bg-base-100 rounded-box w-32">
                            ...
                            <li>
                              <a onClick={() => handleDeleteLink(link.id)} className="text-error">
                                <Trash2 className="w-4 h-4" />
                                Delete
                              </a>
                            </li>
            ...
            {totalPages > 1 && (
              <div className="flex justify-between items-center mt-4">
                <div className="text-sm text-gray-600">
                  Page {currentPage} of {totalPages} ({filteredLinks.length} total)
                </div>
                <div className="join">
                  <button
        ...
        <div className="modal modal-open">
          <div className="modal-box max-w-md">
            ...
            <form onSubmit={handleEditLink}>
              ...
              <div className="form-control mb-4">
                <label className="label">
                  <span className="label-text">New Password (leave empty to keep current)</span>
                </label>
                <input
                  type="password"
                  className="input input-bordered"
